        ...
        <div className=" flex flex-col lg:flex-row h-full justify-center items-center text-primary relative">
          ...
          <div ref={menuRef} className=" absolute w-full z-10">
            <div className=" flex justify-center items-end gap-4 lg:gap-[1.563vw]">
              <div className=" flex justify-between items-center lg:p-[0.833vw] bg-[#f3f2dd] custom-shadow">
                <h6 className=" lg:pe-[0.833vw]  border-r border-[#5E2A29] seasons lg:text-[1.458vw]">
                  01
                </h6>
                <p className=" content lg:mx-[0.833vw]">early years</p>
                <Image
                  height={40}
                  width={40}
              ...
              <button
                ...
                className=" border border-[#5E2A29] p-3 lg:py-[0.521vw] lg:px-[1.042vw] lg:text-[0.833vw] content flex justify-center items-center gap-2"
              >
                Skip
                <Image
                  height={18}
